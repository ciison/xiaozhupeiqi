...
type Service interface {
	// 登录
	Login(ctx context.Context, in *Input, opts ...client.CallOption) (*Output, error)
	// 注册
	Register(ctx context.Context, in *Input, opts ...client.CallOption) (*Output, error)
...
func (c *service) Login(ctx context.Context, in *Input, opts ...client.CallOption) (*Output, error) {
	req := c.c.NewRequest(c.name, "Service.Login", in)
	out := new(Output)
...
func (c *service) Register(ctx context.Context, in *Input, opts ...client.CallOption) (*Output, error) {
	req := c.c.NewRequest(c.name, "Service.Register", in)
	out := new(Output)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ServiceHandler interface {
	// 登录
	Login(context.Context, *Input, *Output) error
	// 注册
	Register(context.Context, *Input, *Output) error
...
func RegisterServiceHandler(s server.Server, hdlr ServiceHandler, opts ...server.HandlerOption) error {
	type service interface {
		Login(ctx context.Context, in *Input, out *Output) error
		Register(ctx context.Context, in *Input, out *Output) error
...
func (h *serviceHandler) Login(ctx context.Context, in *Input, out *Output) error {
	return h.ServiceHandler.Login(ctx, in, out)
}

func (h *serviceHandler) Register(ctx context.Context, in *Input, out *Output) error {
	return h.ServiceHandler.Register(ctx, in, out)
}
